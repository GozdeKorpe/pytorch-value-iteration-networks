...
python test_reproduction.py --weights trained/vin_8x8.pth --imsize 8 --k 10 
python test.py --weights trained/vin_16x16.pth --datafile dataset/gridworld_16x16.npz  --imsize 16 --k 20 